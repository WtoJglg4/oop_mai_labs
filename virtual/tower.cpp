...
void PaintedTower:: Draw(HPEN pen){
	SelectObject(hdc, pen);
...
EyeTower:: EyeTower(int InitX, int InitY, int BaseLength, int ObservationRadius, int TotalHigh): Tower(InitX, InitY, BaseLength, ObservationRadius, TotalHigh){
...
void EyeTower:: Draw(HPEN pen){
	...
	//ресницы
	HPEN blackPen = CreatePen(PS_SOLID, 7, RGB(1, 1, 1));
	SelectObject(hdc, blackPen);
	MoveToEx(hdc, x, y - ObservationHigh +  3 * ObservationRadius / 2, NULL);
	LineTo(hdc, x, y - ObservationHigh - 3 * ObservationRadius / 2);
	MoveToEx(hdc, x - ObservationRadius / 2, y - ObservationHigh + 3 * ObservationRadius / 2, NULL);
	LineTo(hdc, x + ObservationRadius / 2, y - ObservationHigh + 3 * ObservationRadius / 2);
	MoveToEx(hdc, x + ObservationRadius / 2, y - ObservationHigh + 3 * ObservationRadius / 2, NULL);
	LineTo(hdc, x - ObservationRadius / 2, y - ObservationHigh + 3 * ObservationRadius / 2);
	...
	SelectObject(hdc, blackPen2);
	FillCirlce(hdc, x, y - ObservationHigh, ObservationRadius / 2);
